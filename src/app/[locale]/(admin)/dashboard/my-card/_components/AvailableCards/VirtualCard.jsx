  ...
  return (
    <>
      <div
        ...
        className="relative w-full md:w-[380px]  rounded-2xl border border-primary-300/40 dark:border-primary-800 bg-primary-50 dark:bg-primary-900 p-6 overflow-hidden"
      >
      ...
      <CardDetailsModal open={isModalOpen} onCancel={handleCancelModal} />
    </>
  );
}
