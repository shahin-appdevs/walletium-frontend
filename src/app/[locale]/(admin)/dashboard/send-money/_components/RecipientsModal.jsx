...
const RecipientsModal = ({
  ...
  const t = useTranslations("Dashboard.sendMoney.recipientModal");
      ...
      title={
        <div className={`flex items-center gap-2 rtl:flex-row-reverse`}>
          ...
          <span className="font-semibold">
            {confirmDetails ? t("sendMoneyPreview") : t("selectRecipient")}
          </span>
        </div>
      }
      width={560}
        ...
        {confirmDetails ? (
          ...
          <div className="space-y-4">
            ...
            <PrimaryButton
              ...
              iconClassName={`duration-300 rtl:-rotate-90 group-hover/primary-btn:-translate-y-1 rtl:group-hover/primary-btn:-translate-x-1 ltr:group-hover/primary-btn:translate-x-1`}
              onClick={() =>
                onConfirmSend?.({
                  ...confirmDetails,
          ...
          <div className="space-y-4">
              ...
              {isRecipientsLoading ? (
                <div className="space-y-3">
                  {[...Array(4)].map((_, i) => (
                    <div
                      key={i}
                      className={`flex items-center gap-3 p-3 rounded-xl bg-neutral-50 dark:bg-slate-900 rtl:flex-row-reverse`}
                    >
                ...
                <Empty
                  description={
                    searchText ? t("noResultsFound") : t("noRecipientsFound")
                  }
                  className="py-8"
                />
              ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative shrink-0">
                        ...
                        {isSelected && (
                          <div
                            className={`absolute -bottom-0.5 w-5 h-5 rounded-full bg-primary flex items-center justify-center shadow-sm rtl:-left-0.5 ltr:-right-0.5`}
                          >
                            <LucideIcon
                              name="Check"
                              size={12}
            ...
            {selectedRecipient && (
              <div className="rounded-xl bg-neutral-50 dark:bg-slate-900 dark-border p-3 shadow-xs">
                ...
                <div className="divide-y divide-gray-200 dark:divide-gray-800">
                  {[
                    { label: t("name"), value: selectedRecipient.name },
                    { label: t("email"), value: selectedRecipient.email },
                    { label: t("country"), value: selectedRecipient.country },
                    {
                      label: t("address"),
                      value: [
